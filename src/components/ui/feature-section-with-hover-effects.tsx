...
export interface FeatureHoverItem {
  title: string;
  description: string;
  icon?: TablerIcon;
}
...
export interface FeaturesSectionWithHoverEffectsProps {
  features?: FeatureHoverItem[];
}

const defaultFeatures: FeatureHoverItem[] = [
  {
...
export function FeaturesSectionWithHoverEffects({ features = defaultFeatures }: FeaturesSectionWithHoverEffectsProps) {
  return (
...
const Feature = ({
  ...
  const IconComponent: TablerIcon | undefined = icon;
